...
#let conf(
  ...
  lang: "de",
  region: "DE",
  font: ("Source Serif Pro", "Noto Sans", "Liberation Sans"),
  font-heading: ("Source Sans Pro", "Noto Sans", "Liberation Sans"),
  codefont: ("JetBrains Mono", "Fira Code", "Liberation Mono"),
  mathfont: (),
  fontsize: 12pt,
  linestretch: 1.65,
  paper: "a4",
